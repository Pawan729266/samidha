                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-home"></i> Volunteers <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="/admin/volunteers">Volunteers list</a></li>
                            <li><a href="/admin/volunteer/add">Add Volunteer</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-users"></i> Teams <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                             <li><a href="/admin/my-teams">My Teams List</a></li>
                            <li><a href="/admin/teams">Teams List</a></li>
                            <li><a href="/admin/team/add">Add Team</a></li>
                        </ul>
                    </li>
                    <li><a href="/admin/notifications"><i class="fa fa-bell "></i> Notifications<span class="fa fa-chevron-down"></span></a>                    
                    </li>
                    <li>
